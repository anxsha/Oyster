...
namespace Oyster.Areas.Identity.Pages.Account.Manage
{
    public partial class EmailModel : PageModel
    {
        ...
        private async Task LoadAsync(OysterUser user)
        {
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (Input.NewEmail != email) {
                var userWithEnteredEmail = await _userManager.FindByEmailAsync(Input.NewEmail);
                if (userWithEnteredEmail != null) {
                    StatusMessage = "This email is already used.";
                ...
                ConfirmEmailChangeUrl = callbackUrl;
                return RedirectToPage();
            }
